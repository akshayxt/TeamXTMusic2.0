...
async def daxxhub (_, message):
    ...
    papadaxx(f"{text}").save(f"daxxhub _{message.from_user.id}.png")
    await message.reply_photo(f"daxxhub _{message.from_user.id}.png")
    os.remove(f"daxxhub _{message.from_user.id}.png")
####
